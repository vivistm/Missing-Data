...
- Problem  bei Impute, than transform wir dürfen beim Imputieren nicht X3 verwenden und nur na von X3 werden imputiert
...
for (s in 1:S) {
  ...
  data1$X3 <- data1$X2^2 # hier überschreiben wir die Werte wieder, sodass auch NAs vorliegen
