...
for (i in 1:iterations) {
  ...
  ImpData <- mice(data[, -which(names(data) == "sinus")], seed = i, m = n_imp)

  model_impute_first <- with(ImpData, lm(Y ~ x_1 + x_2 + x_3 + x_4 + sin(x_1)))
  ...
  model_trans_first <-
    with(ImpData, lm(Y ~ x_1 + x_2 + x_3 + x_4 + sin(x_1)))
  ...
  ImpData <- mice(data[, -which(names(data) == "sinus")],method = "rf", seed = i, m = n_imp)
