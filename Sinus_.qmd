...
```{r}
#| echo: false
pacman::p_load("VIM","rgl","MASS","tidyverse","mice","MASS","future")
```
...
for (i in 1:iterations) {
  ...
  imp_data_pmm_imp_first <- futuremice(data[, -which(names(data) == "sinus")], parallelseed = i, m = n_imp, n.core = n_cores) 
  ...
  imp_data_pmm_trans_first <- futuremice(data,pred = pred, print = FALSE, parallelseed = i, m = n_imp, n.core = n_cores)
  ...
  imp_data_rf_imp_first <- futuremice(data[, -which(names(data) == "sinus_x1")],method = "rf", parallelseed = i, m = n_imp, n_cores= n.cores)
  ...
  imp_data_rf_trans_first <- futuremice(data,method = "rf", pred = pred, print = FALSE, parallelseed = i, m = n_imp, n.core = n_cores)
