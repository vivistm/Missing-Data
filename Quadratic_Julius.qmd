...
for (i in 1:iterations) {
  ...
  imp_data_pmm_imp_first <- mice(data[, -which(names(data) == "x1_squared")], m = n_imp)
...
#   ### Idee:
  ...
  imp_data_poly_com <- mice(data,method = meth,pred = pred,quad.outcome ="Y", m = n_imp)
  ...
  imp_data_rf_imp_first <- mice(data[, -which(names(data) == "x1_squared")], method = "cart", m = n_imp)
