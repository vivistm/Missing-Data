...
#   ### Idee:
  ...
  ImpData <- mice(data[, -which(names(data) == "x1_squared")], method = "cart", seed = i, m = n_imp)
  ...
  results_of_all_methods[["cart_imp_first"]][[i]] <-
  ...
  ImpDataTransFirst <- mice(data,method = "cart",pred = pred, print = FALSE, seed = i, m = n_imp)
  ...
  results_of_all_methods[["cart_trans_first"]][[i]] <-
    calculate_metrics(coeff_trans_first, true_beta)
